...
public class YOLOProcessorResults extends VideoProcessorResults {
	...
	public YOLOProcessorResults(Mat frame, List<Integer> detectedIndexes, List<String> detectedNamesClasses,
			List<Double> detectedConfidences, List<Rect> detectedBoxes, Mat detectedImage) {
		super();
		...
		if (detectedNamesClasses.size() > 0) {
