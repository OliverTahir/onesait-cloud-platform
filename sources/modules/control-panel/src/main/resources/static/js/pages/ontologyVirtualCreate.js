...
var OntologyCreateController = function() {
	...
	var initTemplateElements = function(){
		...
		// EDIT MODE ACTION 
			...
			OntologyCreateController.changeCollection();
			OntologyCreateController.generateSchema();
	...
	return{
	    ...
	    changeCollection: function() {
	        ...
	        $.ajax({
				url : "/controlpanel/ontologies/getInstance/"+ datasource +"/"+ collection,
				type : 'GET',
				dataType: 'text', 
				contentType: 'text/plain',
				mimeType: 'text/plain',
...
jQuery(document).ready(function() {
	...
	$("#datasources").val(datasources[0]);
	$("#datasource").val(datasources[0]);
