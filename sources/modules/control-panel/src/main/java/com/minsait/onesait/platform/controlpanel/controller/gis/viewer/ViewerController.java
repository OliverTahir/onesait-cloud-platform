...
import com.minsait.onesait.platform.controlpanel.rest.management.viewer.layer.FeatureCollection;
import com.minsait.onesait.platform.controlpanel.rest.management.viewer.layer.LayersRest;
...
public class ViewerController {
	...
	@GetMapping("/getLayerData/{layer}")
	public @ResponseBody FeatureCollection getLayerData(@PathVariable("layer") String layer) {
		FeatureCollection result = (FeatureCollection) this.layerRest.getByUserAndIdentification(layer).getBody();
		return result;
	}
