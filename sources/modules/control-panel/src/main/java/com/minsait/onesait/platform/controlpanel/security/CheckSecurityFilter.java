...
public class CheckSecurityFilter implements Filter {
	...
	String[] presets = { "management", "notebook-ops", "deployment", "binary-repository", "dashboard", "model", "dashboardapi" };
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		final Authentication authentication = tokenExtractor.extract(req);

		// try to get auth from user_token
		if (userToken != null && authentication == null) {
			extractAuthentication(userToken, req);
		}
	...
	Authentication getInfo(Authentication authentication, HttpServletRequest req) {
		...
		try {
			...
			if (authentication != null) {
				...
				final UsernamePasswordAuthenticationToken authRequest = (UsernamePasswordAuthenticationToken) info
