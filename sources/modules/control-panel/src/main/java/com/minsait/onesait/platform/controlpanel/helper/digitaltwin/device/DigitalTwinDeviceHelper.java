...
public class DigitalTwinDeviceHelper {
	...
	public File generateProject(String identificacion, Boolean compile, Boolean sensehat) {
		...
		try {
			...
			// Create logic.js
			File fileStatic = new File(src.getAbsolutePath() + File.separator + RESOURCES_STR + File.separator
			...
			// Create Wot.json
			File fileJson = new File(src.getAbsolutePath() + File.separator + RESOURCES_STR + File.separator + "static"
					+ File.separator + "json");
