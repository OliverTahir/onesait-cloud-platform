...
import com.minsait.onesait.platform.config.services.virtual.datasources.VirtualDatasourceService;
...
public class VirtualDatasourceController {
	...
	public @ResponseBody Boolean getTables(@RequestParam String datasource, @RequestParam String user,
			@RequestParam String credentials, @RequestParam String sgdb, @RequestParam String url,
			@RequestParam String queryLimit) {
		return this.virtualDatasourceService.checkConnection(datasource, user, credentials, sgdb, url, queryLimit);
	}
