...
public class ConfigurationRestService extends ManagementRestServices {
	
	private static final String OP_CONFIGURATION = "/configurations";
	...
	@GetMapping(OP_CONFIGURATION + "/type/{type}/environment/{environment}/realm/{realm}")
	@ApiResponses(@ApiResponse(code = 200, message = "OK", response = ConfigurationSimplified.class))
	...
	@GetMapping(OP_CONFIGURATION + "/{id}")
	@ApiResponses(@ApiResponse(code = 200, message = "OK", response = ConfigurationSimplified.class))
	...
	@ApiOperation("Get configuration by parameters")
	@GetMapping(OP_CONFIGURATION + "/type/{type}/real/{realm}")
	@ApiResponses(@ApiResponse(code = 200, message = "OK", response = ConfigurationSimplified[].class))
	...
	@PutMapping(OP_CONFIGURATION + "/{id}")
	...
	@DeleteMapping(OP_CONFIGURATION + "/{id}")
