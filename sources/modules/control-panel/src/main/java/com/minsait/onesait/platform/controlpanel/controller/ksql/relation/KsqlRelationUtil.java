...
public class KsqlRelationUtil {
	...
	public KsqlResource convertFromDTO(KsqlResourceDTO dto, String sessionUserId) {
		...
		if (entity == null) {
			...
			entity.setStatemetnText(dto.getStatement());
			...
			entity.parseStatementTextAndGetDependencies();
	...
	public KsqlResource getOriginalFromDTO(KsqlResourceDTO dto, String sessionUserId) {
		KsqlResource entity = ksqlResourceService.getKsqlResourceById(dto.getResourceId());
		entity.setStatemetnText(dto.getStatement());
		entity.setDescription(dto.getDescription());
		return entity;
