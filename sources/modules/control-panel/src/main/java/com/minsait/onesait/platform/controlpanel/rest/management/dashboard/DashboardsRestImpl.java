				...
				if (category == null && subcategory == null && !dashboards.isEmpty()) {
					...
					for (Dashboard d : dashboards) {
						...
						if (categoryRelation != null) {
							...
							dashboardsResult.add(new DashboardDTO(d.getIdentification(), d.getUser().getUserId(),
									url + d.getId(), c.getIdentification(), subc.getIdentification(), d.getCreatedAt(),
									d.getUpdatedAt()));
						} else {
							dashboardsResult.add(new DashboardDTO(d.getIdentification(), d.getUser().getUserId(),
									url + d.getId(), null, null, d.getCreatedAt(), d.getUpdatedAt()));
						}
					}
					...
					for (Dashboard d : dashboards) {
						...
						if (categoryRelation != null) {
							...
							if (category.equalsIgnoreCase(c.getIdentification())) {
								dashboardsResult.add(new DashboardDTO(d.getIdentification(), d.getUser().getUserId(),
										url + d.getId(), c.getIdentification(), subc.getIdentification(),
