...
public class ModelController {
	...
	public String run(org.springframework.ui.Model model, HttpServletRequest request, @PathVariable("id") String id) {
		...
		if (modl != null) {
			...
			model.addAttribute(PARAMETERS_STR, parameters);
		} else {
	...
	public @ResponseBody String getConfigParagraph(@PathVariable("notebook") String notebookName) {
		...
		if (notebook != null) {
			...
			if (response.getStatusCode() == HttpStatus.OK) {
				...
				try {
					...
					String id = json.getJSONArray("body").getJSONObject(0).getString("id");
					return id;
	...
	public String show(org.springframework.ui.Model model, @PathVariable("id") String id, RedirectAttributes redirect) {
		try {
			...
			if (modelp != null) {
				...
				model.addAttribute(MODEL_DTO_STR, modelp);
				return "models/show";
