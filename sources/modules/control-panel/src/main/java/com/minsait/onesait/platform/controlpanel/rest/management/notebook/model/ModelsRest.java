...
public interface ModelsRest {
	...
	public ResponseEntity<?> executeModel(@ApiParam(value = "User identification", required = true) String userId,
	...
	public ResponseEntity<?> saveExecution(@ApiParam(value = "User identification", required = true) String userId,
			@ApiParam(value = "A JSON with parameters needed yo execute the model", required = true) String params,
			@ApiParam(value = "Model name", required = true) String modelName,
	...
	public ResponseEntity<?> getExecutions(@ApiParam(value = "User identification", required = true) String userId);

	@ApiResponses(@ApiResponse(code = 200, message = "OK", response = String.class))
	@ApiOperation(value = "Show an execution of model")
	@RequestMapping(value = "/showExecution", method = RequestMethod.POST)
	public ResponseEntity<?> showExecution(@ApiParam(value = "User identification", required = true) String userId,
			@ApiParam(value = "Name of the execution", required = true) String executionName);
