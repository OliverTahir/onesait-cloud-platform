 ...
 */
package com.minsait.onesait.platform.api.camel;
	...
	public String context() {
		...
		if (routes == 0) {
			try {
				...
				log.error("Error loading camel set of routes: " + e.getMessage());
			}

			log.info("API Manager Event Loader -> Camel Context Status is: "
					+ camelContextHandler.getDefaultCamelContext().getStatus());
