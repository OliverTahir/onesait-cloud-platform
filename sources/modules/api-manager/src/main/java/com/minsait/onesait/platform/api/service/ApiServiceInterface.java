...
public interface ApiServiceInterface {
	...
	public static final String HTTP_RESPONSE_CODE_HEADER = Exchange.HTTP_RESPONSE_CODE;
	public static final String HTTP_RESPONSE_CODE_BAD_REQUEST = "400";
	public static final String HTTP_RESPONSE_CODE_UNAUTHORIZED = "401";
	public static final String HTTP_RESPONSE_CODE_NOT_FOUND = "404";
	public static final String HTTP_RESPONSE_CODE_FORBIDDEN = "403";
	public static final String HTTP_RESPONSE_CODE_API_LIMIT = "429";
