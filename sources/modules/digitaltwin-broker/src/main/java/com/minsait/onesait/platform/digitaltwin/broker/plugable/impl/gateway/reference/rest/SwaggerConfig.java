...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		final ApiInfo apiInfo = new ApiInfo("Onesaitplatform IoT Digital Twin Rest Gateway",
				"Onesaitplatform IoT Digital Twin Rest Gateway", "v1.0.0", "", "", "Apache License 2.0",
