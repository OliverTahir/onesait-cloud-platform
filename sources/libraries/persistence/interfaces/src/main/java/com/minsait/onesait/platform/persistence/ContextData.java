...
import com.minsait.onesait.platform.persistence.util.CalendarAdapter;
...
public class ContextData implements Serializable {
	...
	public ContextData(JsonNode node) {
		...
		JsonNode source = node.findValue("source");
		if (source != null) {
	...
	@Override
	public int hashCode() {
		return Objects.hash(user, deviceTemplate, device, clientConnection, clientSession, timezoneId, timestamp, source);
	}
	...
	public static Builder builder(String user, String timezoneId, String timestamp, long timestampMillis, String source) {
