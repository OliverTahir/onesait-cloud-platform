...
public class ESBaseApi {
	...
	public static String queryAllSize = START_QUERY + SIZE_JSON + "  ,\"from\": 0\r\n" + "  ,\"query\":\r\n"
			+ "   {\r\n" + "    \"match_all\": {}\r\n" + "   }\r\n" + "}";

	public static String queryAllSizeFromTo = START_QUERY + SIZE_JSON + "  ,\"from\": [FROM]\r\n"
			+ "  ,\"query\":\r\n" + "   {\r\n" + "    \"match_all\": {}\r\n" + "   }\r\n" + "}";

	public static String queryAllSizeFromToQuery = START_QUERY + SIZE_JSON + "  ,\"from\": [FROM]\r\n"
			+ "  ,[QUERY] }";
