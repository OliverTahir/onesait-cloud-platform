...
public class ClientPlatformOntologyRepositoryIntegrationTest {
	...
	public void given_SomeClientPlatformOntologysExist_When_ItIsSearchedByOntologyAndClientPlatform_Then_TheCorrectObjectIsReturned() {
		...
		Assert.assertTrue(this.repository.findByOntologyAndClientPlatform(cpo.getOntology().getIdentification(),
	...
	public void given_SomeClientPlatformOntology_When_ItIsUpdated_Then_TheClientOntologiesAreRemoved() {
		...
		User user = userRepository.findByUserId("developer");
		...
		ClientPlatformOntology cpo1 = new ClientPlatformOntology();
		cpo1.setOntology(ontology1);
		cpo1.setAccesEnum(AccessType.ALL);
		...
		ClientPlatformOntology cpo2 = new ClientPlatformOntology();
		cpo2.setOntology(ontology2);
		cpo2.setAccesEnum(AccessType.ALL);
		...
		assertTrue("There should be 2 ontologies linked with this client platform",clientPlatformOntologies.size() == 2);
		
		ClientPlatformOntology ocpToRemove = repository.findByOntologyAndClientPlatform(ontology1.getIdentification(), cpStored.getIdentification());
