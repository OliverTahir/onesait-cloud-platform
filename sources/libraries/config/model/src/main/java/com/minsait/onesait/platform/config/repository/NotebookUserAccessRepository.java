...
public interface NotebookUserAccessRepository extends JpaRepository<NotebookUserAccess, String> {
	...
	@Override
	@CacheEvict(cacheNames = "NotebookUserAccessRepository")
	...
	//List<NotebookUserAccess> findByNotebook();
	...
	NotebookUserAccess findByNotebookAndUserAndAccess(@Param("id") Notebook id, @Param("user") User user, @Param("notebookUserAccessType") NotebookUserAccessType notebookUserAccessType);
