...
public class MQTTApplicationExample {
	...
	public static void main(String[] args)
		...
		if (args == null || args.length == 0) {
			...
			/*
			 * System.out.println(
			 * "Trying >MQTTApplicationExample ssl://s4citiespro.westeurope.cloudapp.azure.com:8883 clientdevelkeystore.jks changeIt!"
			 * );
			 *
			 * url = "ssl://s4citiespro.westeurope.cloudapp.azure.com:8883"; keyStorePath =
			 * "s:\\sources\\onesait-platform\\onesait-cloud-platform\\sources\\libraries\\client-libraries\\java-client\\clientdevelkeystore.jks";
			 * keyStorePassword = "changeIt!"; sslConfig = new
			 * MQTTSecureConfiguration(keyStorePath, keyStorePassword);
			 */
			System.out.println(ASTERISKS);
