	...
	public List<JsonNode> query(String ontology, String query, SSAPQueryType queryType) throws SSAPConnectionException {
		...
		try {
			...
			if (!response.isSuccessful()) {
				...
				log.error(QUERY_ERROR + response.toString());
				throw new SSAPConnectionException(QUERY_ERROR + response.toString());
			}
	...
	private JsonNode sendInsert(String ontology, String instance) throws SSAPConnectionException {
		...
		try {
			...
			if (!response.isSuccessful()) {
				...
				log.error("Error in insert . Response:" + response.toString());
				throw new SSAPConnectionException("Error in insert . Response:" + response.toString());
			}
	...
	private JsonNode updateWithConfirmation(String ontology, String instance, String id, boolean includeIds)
		...
		try {
			...
			if (!response.isSuccessful()) {
				...
				log.error(UPDATE_ERROR + response.toString());
				throw new SSAPConnectionException(UPDATE_ERROR + response.toString());
			}
	...
	private JsonNode deleteWithConfirmation(String ontology, String id, boolean includeIds)
		...
		try {
			...
			if (!response.isSuccessful()) {
				...
				log.error(DELETE_ERROR + response.toString());
				throw new SSAPConnectionException(DELETE_ERROR + response.toString());
			}
