	...
	private class EntityCache {
		...
		private EntityCache(EntityCache other) {
			...
			for (Class<?> clazz : clazzes) {
				Map<Serializable, Object> entities = other.cache.get(clazz);
				Set<Serializable> ids = entities.keySet();
...
//			if (cache.containsKey(clazz)) {
//				Map<Serializable, Object> instances = cache.get(clazz);
//				instances.remove(id);
//			}
//		}
...
//			Set<Object> entitiesSet = new HashSet<Object>();		
//			Collection<Map<Serializable, Object>> values = cache.values();
//			for (Map<Serializable, Object> instances : values) {
//				Collection<Object> objects = instances.values();
//				entitiesSet.addAll(objects);
//			}		
//			return entitiesSet;	
			return cache;
		}
	...
	public DataToDB() {
		//this.whiteList = MigrationUtils.whitelist().getWhitList();
	}
