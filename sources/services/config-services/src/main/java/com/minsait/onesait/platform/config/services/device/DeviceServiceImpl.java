...
public class DeviceServiceImpl implements DeviceService {
	...
	public Device updateDevice(Device device) {
		deviceRepository.updateDevice(device.getClientPlatform(), device.getIdentification(), device.getSessionKey(),
				device.getProtocol(), device.getLocation(), device.getUpdatedAt(), device.getStatus(),
				device.isConnected(), device.isDisabled(), device.getId());
		return device;
	}
